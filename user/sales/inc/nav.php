...
.sf-menu li:hover ul {
    display: block; /* Show on hover */
		...
		<div class="menu-wrap">
				...
				<ul class="sf-menu">
					<li>
						<a href="../shopping/index.php">Home</a>
					</li>
					<li>
						<a href="#">Shop</a>
						...
						<?php
						 ...
						 ?>
							<li><a href="../shopping/index.php?id=<?php echo $catr['id']; ?>"><?php echo $catr['name']; ?></a></li>
						<?php } ?>
						</ul>
					</li>
					<li>
						...
						<div class="mobnav-subarrow"><i class="fa fa-plus"></i></div>
						<ul>
							<li><a href="../shopping/my-account.php">My Orders</a></li>
							<li><a href="../shopping/edit-address.php">Update Address</a></li>
							<li><a href="../shopping/logout.php">Logout</a></li>
						</ul>
					</li>
					<li>
					    <a href="#">Sell</a>
						<div class="mobnav-subarrow"><i class="fa fa-plus"></i></div>
						<ul>
							<li><a href="sale.php">Apply sales</a></li>
							<li><a href="acceptedproducts.php">Accepted products</a></li>
							<li><a href="rejected.php">Rejected Products</a></li>
						</ul>
					</li>
				</ul>
				...
				<?php $cart = $_SESSION['cart']; ?>
					<div class="s-cart">
						...
						<div class="cart-info">
							...
							<div class="cart-btn">
								<a href="../shopping/cart.php">View Bag</a>
