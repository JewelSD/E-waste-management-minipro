			...
			<div class="container">
				<div class="row">
					<div class="page_header text-center">
						<p>Get assured services on every purchased products</p>
					</div>
						...
						<div class="col-md-5">
							<div class="gal-wrap">
								<div id="gal-slider" class="flexslider">
									<ul class="slides">
										<li><img src="../../tech/<?php echo $prodr['thumb']; ?>" class="img-responsive" alt=""/></li>
									</ul>
								</div>
								<ul class="gal-nav">
									<li>
										<div>
											<img src="../../tech/<?php echo $prodr['thumb']; ?>" class="img-responsive" alt=""/>
											<img src="../../tech/<?php echo $prodr['thumb']; ?>" class="img-responsive" alt=""/>
										</div>
									</li>
								</ul>
					...
					<div class="tab-style3">
						...
						<div style="height: auto;" class="tab-content tpl-minimal-tabs-cont align-center section-text">
							<div  class="tab-pane fade active in" id="mini-one">
								<p>About : <?php echo $prodr['description']; ?></p>
							</div>
...
<!-- Grid row -->
  ...
  <a target="_blank" href="#">
    <img src="../../tech/<?php echo $prodr['img1']; ?>" alt="img1" width="720" height="1280">
  </a>
</div>

<div class="gallery">
  <a target="_blank" href="#">
    <img src="../../tech/<?php echo $prodr['img2']; ?>" alt="img2" width="720" height="1280">
  </a>
</div>

<div class="gallery">
  <a target="_blank" href="#">
    <img src="../../tech/<?php echo $prodr['img3']; ?>" alt="img3" width="720" height="1280">
  </a>
</div>

<div class="gallery">
  <a target="_blank" href="#">
    <img src="../../tech/<?php echo $prodr['img4']; ?>" alt="img4" width="720" height="1280">
  </a>
</div>

<div class="gallery">
  <a target="_blank" href="#">
    <img src="../../tech/<?php echo $prodr['img5']; ?>" alt="img5" width="720" height="1280">
  </a>
</div>
								...
								<div class="sm-item isotope-item">
									<div class="product">
										<div class="product-thumb">
											<img src="../../tech/<?php echo $relr['thumb']; ?>" class="img-responsive" alt="">
